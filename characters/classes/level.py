class Level(object):
    __slots__ = ["value", "attack_bonus", "experience_required", "hit_dice", "saving_throws_set",
                 "special_ability_set", "spell_slots_set"]

    def __init__(self, value, attack_bonus, experience_required, hit_dice, saving_throws_set,
                 special_ability_set=None, spell_slots_set=None):
        self.value = value
